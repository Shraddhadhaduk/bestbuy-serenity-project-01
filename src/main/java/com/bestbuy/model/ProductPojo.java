...
public class ProductPojo {
    ...
    public static ProductPojo getProductsPojo(String name, String type, Double price, String upc, Integer shipping, String description, String manufacturer, String model, String url) {
